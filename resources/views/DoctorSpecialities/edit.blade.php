...
<div class="row justify-content-center">
 <div class="col-md-6 col-md-offset-3">
    <h4>{{$Title}} | doctor specialities</h4>
    <hr>
    ...
    @csrf 
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="user_id" value= "{{$Info->user_id}}">
            <span style="color:red">@error ('user_id'){{$message}} @enderror</span>
        </div>

        <div class="form-group">
            <label for=""> speciality id</label>
            <input type="text" class="form-control" name="speciality_id" value= "{{$Info->speciality_id}}">
